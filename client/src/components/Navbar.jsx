...
function Navbar() {
  ...
  return (
    <nav className="flex  flex-wrap items-center justify-between px-4 md:px-14 py-4 border-b border-gray-300 bg-white relative transition-all w-full">
      {/* Logo */}
      ...
      <div className="hidden sm:flex items-center gap-8">
        <NavLink to="/" className="hover:text-indigo-600 pl-5">
          Home
        </NavLink>
        <NavLink
          to="/products"
          className="hover:text-indigo-600 block whitespace-nowrap"
        >
          All Products
        </NavLink>
      ...
      <div className="flex items-center gap-6 sm:hidden">
        ...
        >
          <img
            ...
            className="w-6 opacity-80"
          />
          <button className="absolute -top-2 -right-2 text-xs text-white bg-primary w-[18px] h-[18px] rounded-full flex items-center justify-center">
            {getCartCount()}
          </button>
        </div>
        <button
